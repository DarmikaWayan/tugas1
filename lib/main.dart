  ...
  Widget build(BuildContext context){
    return new Scaffold(
      ...
      body: Center(
        ...
        child: Image(image:AssetImage('images/wayan.JPG'),
          width: 150.0,
          height: 150.0,
          fit: BoxFit.cover,
        ),
              ...
              Text(
                  "I Wayan Darmika", style: TextStyle(color: Colors.blue, fontSize: 20.0, height: 2.0, fontWeight: FontWeight.bold,),),
              Text(
                      ...
                      child: Card(
                          ...
                          child: Column (
                            children: <Widget>[Icon(Icons.home, size: 110, color: Colors.greenAccent,),
                              Text('Busungbiu',style: TextStyle(color: Colors.greenAccent, fontSize: 17.0, height: 2.0, fontWeight: FontWeight.bold,),)],
                          )
                      ),
                    )
                ],
                      ...
                      child: Card(
                          ...
                          child: Column (
                            children: <Widget>[Icon(Icons.music_note, size: 110, color: Colors.pinkAccent,),
                              Text('All Genre',style: TextStyle(color: Colors.pinkAccent, fontSize: 17.0, height: 2.0, fontWeight: FontWeight.bold,),)],
                          )
                      ),
                    ),
